"""
Process NDVI and luminance data
"""
import os
...
def treat_maps(method: str, output: str):
    ...
    for map_name in tqdm(all_maps):
        ...
        for download in downloads:
            ...
            time_string = request["request"]["payload"]["input"]["data"][0][
        ...
        res_values = [v[1] for v in values]
        file = plt.figure()
        plt.plot(dates, res_values, marker='o')
        plt.ylim([-1, 1])
